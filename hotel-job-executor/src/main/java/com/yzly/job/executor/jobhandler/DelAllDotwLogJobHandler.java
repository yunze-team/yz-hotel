 ...
 * @desc
 **/
@JobHandler(value = "delAllDotwLogJobHandler")
@Component
public class DelAllDotwLogJobHandler extends IJobHandler {
    ...
    public ReturnT<String> execute(String param) throws Exception {
        XxlJobLogger.log("del dotw log job execute start.");
        String result = taskControllerInter.delAllDotwLog();
        XxlJobLogger.log("del dotw log job result: " + JSONObject.toJSONString(result));
